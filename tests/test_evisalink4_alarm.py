...
class TestEvisalink4(unittest.TestCase):
    ...
    def test_parse_html(self):
        ...
        self.assertEqual(cur_weather.alarm.all_zones_closed, 1)
        self.assertEqual(cur_weather.whole_house_fan.fan_zones_all, 0)
        self.assertEqual(cur_weather.whole_house_fan.fan_zones_some, 0)
        ...
        self.assertEqual(cur_weather.alarm.sliding_glass_door, 0)
